...
export default function MoreWorks() {
  ...
  const defaultMediaItems: MediaItem[] = [
    {
      id: 1,
      type: "image",
      url: "https://images.unsplash.com/photo-1687180498602-5a1046defaa4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsdXh1cnklMjBmdXJuaXR1cmUlMjBzaG93cm9vbSUyMGludGVyaW9yfGVufDF8fHx8MTc3NDE2NTA1MHww&ixlib=rb-4.1.0&q=80&w=1080",
      title: "صالة عرض فاخرة",
      description: "تصميم داخلي أنيق"
    },
    {
      id: 2,
      type: "image",
      url: "https://images.unsplash.com/photo-1771926343760-c39c17d6a200?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlbGVnYW50JTIwc29mYSUyMGNvbGxlY3Rpb24lMjBkaXNwbGF5fGVufDF8fHx8MTc3NDE2NTA1MHww&ixlib=rb-4.1.0&q=80&w=1080",
      title: "مجموعة قنفات راقية",
      description: "تشكيلة متنوعة"
    },
    {
      id: 3,
      type: "image",
      url: "https://images.unsplash.com/photo-1613545325268-9265e1609167?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcmVtaXVtJTIwbGl2aW5nJTIwcm9vbSUyMGRlY29yfGVufDF8fHx8MTc3NDE2NTA1MHww&ixlib=rb-4.1.0&q=80&w=1080",
      title: "ديكور صالة راقي",
      description: "أثاث فاخر"
    },
    {
      id: 4,
      type: "video",
      url: "https://www.youtube.com/embed/dQw4w9WgXcQ",
      title: "فيديو عرض المنتجات",
      description: "جولة في المعرض"
    },
    {
      id: 5,
      type: "image",
      ...
      title: "قنفة عصرية فاخرة",
      description: "تصميم مودرن"
    },
    {
      id: 6,
      type: "video",
    ...
    },
    {
      id: 10,
      type: "image",
      url: "https://images.unsplash.com/photo-1671836942058-7231fe7b895a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzbGVlayUyMG1vZGVybiUyMGNvdWNoJTIwZGVzaWdufGVufDF8fHx8MTc3NDE2NDUwM3ww&ixlib=rb-4.1.0&q=80&w=1080",
      title: "تصميم أنيق",
    ...
    },
    {
      ...
      title: "أثاث عربي مودرن",
      description: "راحة وفخامة"
    },
    {
      id: 12,
      type: "video",
      url: "https://www.youtube.com/embed/dQw4w9WgXcQ",
      title: "جولة افتراضية",
      description: "تعرف على معرضنا"
    },
  ];

  // Load from localStorage or use default
  const getInitialMedia = () => {
    const savedMedia = localStorage.getItem('moreWorksMedia');
    if (savedMedia) {
      try {
  ...
  useEffect(() => {
    localStorage.setItem('moreWorksMedia', JSON.stringify(mediaItems));
  }, [mediaItems]);
      ...
      <header className="bg-[#1a1a1a] border-b border-[#d4af37]/20 sticky top-0 z-40 backdrop-blur-md bg-[#1a1a1a]/95">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <Link to="/gallery" className="flex items-center gap-3 text-[#d4af37] hover:text-[#c9a02e] transition-colors">
              <ArrowRight className="w-6 h-6" />
              <span className="font-bold text-lg">العودة للمعرض</span>
            </Link>
            <h1 className="text-2xl md:text-3xl font-bold text-[#d4af37]">المزيد من الأعمال</h1>
          </div>
        </div>
      </header>
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <h2 className="text-4xl md:text-6xl font-bold mb-6">
              أعمال <span className="text-[#d4af37]">إضافية</span>
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              استكشف المزيد من تصاميمنا وأعمالنا المميزة
            </p>
